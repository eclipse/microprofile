...
// For example: with next line you could set imagesdir attribute to subfolder "image" relative to the folder where this config file is located.
// :imagesdir: {asciidoctorconfigdir}/image
:imagesdir: ./image
//
