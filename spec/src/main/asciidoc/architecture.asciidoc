...
[[microprofile4.0-RC3]]
=== MicroProfile 4.0 Release Candidate 3 (Q42020)
// MicroProfile 4.0-RC3 is the 14th platform release for the
// https://projects.eclipse.org/projects/technology.microprofile[MicroProfile project].
MicroProfile 4.0-RC3 is based on Jakarta EE 8, the first MicroProfile release to
...
The complete list of MicroProfile 4.0-RC3 specifications includes:
...
Here is the link to https://github.com/eclipse/microprofile/releases/tag/4.0-RC3[the github repository] for this Eclipse-based project.
