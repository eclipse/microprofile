...
Jakartat RESTful Web Services 2.1),
or they be a component of the MicroProfile project (such as Config 1.3).
...
The complete list of MicroProfile 4.0-M1 specifications includes:
 ...
 - https://github.com/eclipse/microprofile-fault-tolerance/releases/tag/3.0-RC1[MicroProfile Fault Tolerance 3.0]
