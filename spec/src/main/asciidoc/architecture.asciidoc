...
* https://download.eclipse.org/microprofile/microprofile-config-2.0-RC1/microprofile-config-spec.html#_incompatible_changes[Config]
* https://download.eclipse.org/microprofile/microprofile-fault-tolerance-3.0-RC2/microprofile-fault-tolerance-spec.html#_backward_incompatible_changes[Fault Tolerance]
* https://download.eclipse.org/microprofile/microprofile-health-3.0-RC5/microprofile-health-spec.html#release_notes_3_0[Health]
* https://download.eclipse.org/microprofile/microprofile-metrics-3.0-RC2/microprofile-metrics-spec-3.0-RC2.html#_breaking_changes[Metrics]
* https://download.eclipse.org/microprofile/microprofile-open-api-2.0-RC3/microprofile-openapi-spec.html#_release_notes_for_microprofile_openapi_2_0[Open API]
...
The complete list of MicroProfile 4.0-RC1 specifications includes:
 ...
 - https://github.com/eclipse/microprofile-config/releases/tag/2.0-RC1[MicroProfile Config 2.0-RC1]
 - https://github.com/eclipse/microprofile-fault-tolerance/releases/tag/3.0-RC2[MicroProfile Fault Tolerance 3.0-RC2]
 - https://github.com/eclipse/microprofile-health/releases/tag/3.0-RC5[MicroProfile Health 3.0-RC5]
 - https://github.com/eclipse/microprofile-jwt-auth/releases/tag/1.2-RC1[MicroProfile JWT Authentication 1.2-RC1]
 - https://github.com/eclipse/microprofile-metrics/releases/tag/3.0-RC2[MicroProfile Metrics 3.0-RC2]
 - https://github.com/eclipse/microprofile-open-api/releases/tag/2.0-RC3[MicroProfile OpenAPI 2.0-RC3]
 - https://github.com/eclipse/microprofile-opentracing/releases/tag/2.0-RC2[MicroProfile OpenTracing 2.0-RC2]
