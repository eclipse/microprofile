...
* https://download.eclipse.org/microprofile/microprofile-fault-tolerance-4.0-RC5/microprofile-fault-tolerance-spec-4.0-RC5.html#_incompatible_changes[Fault Tolerance]
...
* https://download.eclipse.org/microprofile/microprofile-open-api-3.0-RC5/microprofile-openapi-spec-3.0-RC5.html#_incompatible_changes[Open API]
* https://download.eclipse.org/microprofile/microprofile-rest-client-3.0-RC5/microprofile-rest-client-spec-3.0-RC5.html#_incompatible_changes[Rest Client]
...
* https://download.eclipse.org/microprofile/microprofile-opentracing-3.0-RC4/microprofile-opentracing-spec-3.0-RC4.html#_incompatible_changes[Open Tracing]
...
The complete list of MicroProfile 5.0-RC1 specifications includes:
 ...
 - https://github.com/eclipse/microprofile-fault-tolerance/releases/tag/4.0-RC5[MicroProfile Fault Tolerance 4.0-RC5]
 ...
 - https://github.com/eclipse/microprofile-opentracing/releases/tag/3.0-RC4[MicroProfile OpenTracing 3.0-RC4]
 - https://github.com/eclipse/microprofile-open-api/releases/tag/3.0-RC5[MicroProfile OpenAPI 3.0-RC5]
 - https://github.com/eclipse/microprofile-jwt-auth/releases/tag/2.0-RC2[MicroProfile JWT Authentication 2.0-RC2]
 - https://github.com/eclipse/microprofile-rest-client/releases/tag/3.0-RC5[MicroProfile Rest Client 3.0-RC5]
