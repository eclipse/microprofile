...
[[microprofile4.0-M1]]
=== MicroProfile 4.0 Milestone 1 (Q32020)
// MicroProfile 4.0-M1 is the 14th platform release for the
// https://projects.eclipse.org/projects/technology.microprofile[Eclipse MicroProfile project].
MicroProfile 4.0-M1 is based on Jakarta EE 8, the first MicroProfile release to
...
Jakarta EE dependencies for all MicroProfile specifications, so all MicroProfile specifications
are updated to major versions.

The following specifications include API breaking changes:

* https://github.com/eclipse/microprofile-config/issues?q=is%3Aissue+milestone%3A%22MP+Config+2.0%22+label%3A%22incompatible+change+%3Awarning%3A%22+is%3Aclosed[Config]
* https://github.com/eclipse/microprofile-fault-tolerance/issues?q=is%3Aissue+milestone%3A3.0+is%3Aclosed+label%3A%22Incompatible+Changes%22[Fault Tolerance]
* https://github.com/eclipse/microprofile-health/issues?q=is%3Aissue+label%3Abreaking_change+is%3Aclosed[Health]
* https://github.com/eclipse/microprofile-metrics/issues?q=is%3Aissue+label%3Aapi-breaking+is%3Aclosed[Metrics]
* https://github.com/eclipse/microprofile-open-api/issues?q=is%3Aissue+milestone%3A%22MP+OpenAPI+2.0%22+label%3Aincompatible-changes+is%3Aclosed[Open API]
...
The complete list of MicroProfile 4.0-M1 specifications includes:
...
Here is the link to https://github.com/eclipse/microprofile/releases/tag/4.0-M1[the github repository] for this Eclipse-based project.
