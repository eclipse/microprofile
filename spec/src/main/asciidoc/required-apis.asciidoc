...
MicroProfile implementations must include the following specifications:
 ...
 - <<jakarta-cdi, CDI (Jakarta Contexts and Dependency Injection) 2.0.2>>
 - <<jakarta-jaxrs, JAX-RS (Jakarta RESTful Web Services) 2.1.6>>
 - <<jakarta-jsonb, JSON-B (Jakarta JSON Binding) 1.0.2>>
 - <<jakarta-jsonp, JSON-P (Jakarta JSON Processing) 1.1.6>>
 - <<jakarta-annotations, Jakarta Annotations 1.3.5>>
