...
MicroProfile implementations must include the following specifications:
 ...
 - <<mp-jwt-auth, MicroProfile JWT Authentication 2.0>> (TODO - 2.1?)
...
MicroProfile APIs and specifications use Java SE 11 for both source and target compatibility. MicroProfile
implementations are free to provide support for runtimes starting at Java SE 11 or higher.
...
[[jakarta-annotations]]
=== Jakarta Annotations 2.0 (TODO 2.1?)
...
[[mp-jwt-auth]]
=== MicroProfile JWT Authentication 2.0 (TODO 2.1?)
