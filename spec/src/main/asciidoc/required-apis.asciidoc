...
Compliant implementations of Eclipse MicroProfile 3.2 must provide at least the following APIs and minimum versions.
...
MicroProfile applications that make use of APIs or versions not mentioned below are not considered portable.
 ...
 - <<mp-health-check, Eclipse MicroProfile Health 2.1>>
 - <<mp-jwt-auth, Eclipse MicroProfile JWT Authentication 1.1>>
 - <<mp-metrics, Eclipse MicroProfile Metrics 2.2>>
...
[[mp-health-check]]
=== Eclipse MicroProfile Health 2.1
...
[[mp-metrics]]
=== Eclipse MicroProfile Metrics 2.2
