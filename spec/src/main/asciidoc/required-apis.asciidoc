...
MicroProfile applications that make use of APIs or versions not mentioned below are not considered portable.
 ...
 - <<mp-metrics, Eclipse MicroProfile Metrics 2.0>>
 - <<mp-openapi, Eclipse MicroProfile OpenAPI 1.1>>
 - <<mp-opentracing, Eclipse MicroProfile OpenTracing 1.3>>
 - <<mp-rest-client, Eclipse MicroProfile Rest Client 1.3.1>>
...
[[mp-rest-client]]
=== Eclipse MicroProfile Rest Client 1.3.1
...
- https://github.com/eclipse/microprofile-rest-client/releases/tag/1.3.1
