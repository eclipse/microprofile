...
This specification documents the component specification contents of each release. An implementation of this specification is free to pick up a later patch release of any component specifications.
