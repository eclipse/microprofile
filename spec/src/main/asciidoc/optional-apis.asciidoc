...
MicroProfile includes the following specifications which are optional for implementations.  Implementations must list in CCRs and Public TCK Results Summary pages each optional API that is not implemented.
